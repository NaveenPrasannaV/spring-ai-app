package org.nit.springaiapp.controller;
...
//    }
    ...
    public String recommend(@RequestParam String type, @RequestParam String year, @RequestParam String lang) {
        ...
        String tempt = """
                I want to watch a good rated {type} movie released in the year {year} in {lang} language.
                Make sure it is top rated movie.
                Suggest me one specific movie with cast and running time.
                """;
